...
//    return Scaffold(
//       appBar: AppBar(title: Text('Purchases'),centerTitle: true,
//       ),
//       body: Column(
//         mainAxisAlignment: MainAxisAlignment.center,
//         crossAxisAlignment: CrossAxisAlignment.center,
...
//         child: Container(
//           padding: EdgeInsets.all(5),
//           child: Text("BENGOO G9000 Stereo Gaming Headset for PS4 PC Xbox One PS5 Controller, Noise Cancelling Over Ear Headphones with Mic, LED Light, Bass Surround, Soft Memory Earmuffs for Laptop Mac Nintendo NES Games"),
//         ),
//       ),
//     ]),
//     TableRow(children: [
...
//         child: Container(
//           padding: EdgeInsets.all(5),
//           child: Text("Samsung Galaxy A52 gives you 6.5” Infinity-O display & super-smooth 90Hz. The versatile quad camera helps you to capture the world as you see it. Take amazing photos with the revolutionary 64MP OIS camera and experience improved gaming with the long-lasting battery and 25w super-fast charging. Protected by Gorilla Glass 5."),
//         ),
//       ),
//     ]),
//   ],
